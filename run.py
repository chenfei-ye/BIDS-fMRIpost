...
"""
# /root/miniconda3/bin/labelconvert
...
parser.add_argument('--session_label', help='The label of the session that should be analyzed. The label '
                    ...
                    nargs="+")
parser.add_argument('-scripts_dir', help="path of current scripts", default='/data/cye_code/BIDS-fmripost')
parser.add_argument('-atlas_config', help="path of atlas_config.json", default='/data/cye_code/BIDS-fmripost/atlases/atlas_config.json')
    ...
    for atlas_name in atlases_ls:
        ...
        if atlas_name.split('_')[1] == 'T1w':
            ...
            if os.path.exists(parc_T1w_nii_path):
                ...
                run.command('/root/miniconda3/bin/labelconvert ' + parc_native_path + ' ' + parc_lut_file + ' ' + mrtrix_lut_file + ' ' + parc_T1w_nii_path)
